...
class MyCanvasView(context: Context) : View(context) {
    ...
    private fun touchMove() {
        // if the finger has moved less than a touchTolerance distance, don't draw

        //calculate the distance that has been moved
        var dx = Math.abs(motionTouchEventX - currentX)
        var dy = Math.abs(motionTouchEventY - currentY)
